# Application for storing phone book contacts - version with functional components and Redux library to manage states. The application consists of a form and a contact list with the function of adding, filtering and deleting contacts. The application has authentication/authorization feature and change theme feature from Chakra UI.
